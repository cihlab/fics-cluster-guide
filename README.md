...
3. 若问题成功复现，将步骤2中记录下的**用户名(Who)、操作步骤(How)、操作结果(What)、预期结果(Expect)**（**缺一不可**）整理好，任选一种方式提出问题：
    - 询问周围有经验同学
    - 邮件
    - github issue
    - 管理群
...
### 关于提问需要注意事项
所有人都很忙，没有人（也没有义务）知道你是谁，你在干什么，提问之前务必确认**不能假设对方了解你的上下文**，因此请确保上述信息要点（Who、How、What、Expect）**一次性**体现完整，不要让别人猜也不要让别人来回反复确认，这是最基本的提问礼仪。下面是一些可供参考的SOP操作：
